...
OK, this one demonstrates almost everything you need for a functional Forth. [I have written it up separately.](fcomp.md?rev=tip)
...
* [Moving Forth](https://www.bradrodriguez.com/papers/moving1.htm) -- Brad Rodriguez's multi-part description of implementing Forth on a number of processors. Has some nice stuff on how threading works. Don't get bogged down in the assembler stuff if you're not interested in that -- try to concentrate on the bigger picture.
